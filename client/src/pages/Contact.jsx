...
export default function Contact() {
  ...
  const structuredData = {
    ...
    "@type": "ContactPage",
    "name": "Contact Growphone - Get Your Free Strategy Call",
    "description": "Get a free social media strategy call from India's #1 social growth agency. We'll review your current presence and provide actionable insights.",
    "url": "https://growphone.in/contact",
    "mainEntity": {
      "@type": "Organization",
      "name": "Growphone",
  ...
  return (
    <>
      <SEO 
        title="Contact - Get Your Free Strategy Call"
        description="Get a free social media strategy call from India's #1 social growth agency. We'll review your current presence and provide actionable insights. No strings attached."
        keywords="contact social media agency, free social media audit, strategy call India, social media consultation, digital marketing contact"
        canonicalUrl="https://growphone.in/contact"
        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <div className="contact-detail">
              <div className="icon" aria-label="Phone">📞</div>
              {waHref === '#' ? (
            ...
            <div className="contact-detail">
              <div className="icon" aria-label="Email">📧</div>
              <span>info@growphone.in</span>
            </div>
            <div className="contact-detail">
              <div className="icon" aria-label="Location">📍</div>
